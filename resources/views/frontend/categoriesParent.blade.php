...
@section('content') 
 ...
 @if(!empty($datas[0]->link))
<div style="text-align:center;"><h1>Danh mục sản phẩm</h1></div>
                    ...
                    <div class="product-small box ">
                        <div class="box-image">
                            <div class="image-fade_in_back">
                                <a href="/{{ $data->link }}">
                                <img width="247" height="247" src="{{ asset($data->image) }}" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="" loading="lazy" srcset="{{ asset($data->image) }}" sizes="(max-width: 247px) 100vw, 247px">             </a>
                            </div>
